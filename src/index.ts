...
/**
 * Thailand Law MCP Server — stdio entry point.
 *
 * Provides Thai legislation search via Model Context Protocol.
 * Covers PDPA, Computer Crime Act, Cybersecurity Act, Electronic Transactions Act,
 * and Civil and Commercial Code with Buddhist Era (B.E.) calendar support.
 */
...
const DB_ENV_VAR = 'THAILAND_LAW_DB_PATH';
